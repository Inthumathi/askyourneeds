          ...
          children: [
            Material(
              ...
              child: Container(
                ...
                child:
                isCategoryLoading ||isCategoryItemLoading
                    ? SpinKitFadingCircle(
                  color: primaryColor,
                )
                    :foodAndBeverageSubCategoriesList.isEmpty && dailyNeedsSubCategoriesList.isEmpty
                        ? Padding(
                        ...
                        :
                ListView.builder(
                  itemCount: widget.cateName == CategoriesViewAll.foodBeverages
                      ? foodAndBeverageSubCategoriesList.length
                      : dailyNeedsSubCategoriesList.length,
                  itemBuilder: (ctx, i) {
                    final imageUrl = widget.cateName == CategoriesViewAll.foodBeverages
                        ? ApiConstants.restaurantImageURL +
                        foodAndBeverageSubCategoriesList[i].bannerImg.toString()
                        : ApiConstants.dailyNeedsImageBaseURL +
                        dailyNeedsSubCategoriesList[i].bannerImg.toString();

                    final subCategoryName = widget.cateName == CategoriesViewAll.foodBeverages
                        ? foodAndBeverageSubCategoriesList[i].name.toString()
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        final categoryId = widget.cateName == CategoriesViewAll.foodBeverages
                            ? foodAndBeverageSubCategoriesList[i].sId.toString()
                            : dailyNeedsSubCategoriesList[i].sId.toString();


                        if (widget.cateName == CategoriesViewAll.foodBeverages) {
                          _getFoodAndBeverageSubCategoriesItems(categoryId, widget.accessToken);
                        } else {
                          _getDailyNeedsSubCategoriesItems(categoryId, widget.accessToken);
                        }
                      },
                      child: RotatedBox(
                        quarterTurns: 4,
                          ...
                          child: SingleChildScrollView(
                            child: isCategoryItemLoading
                              ...
                              itemBuilder: (BuildContext ctx, i) {
                                ...
                                final imageItemUrl = widget.cateName ==
                                    CategoriesViewAll.foodBeverages
                                    ? ApiConstants.restaurantImageURL +
                                    foodAndBeverageItemsList[i].img.toString()
                                    : ApiConstants.dailyNeedsImageProductBaseURL +
                                    dailyNeedsItemsList[i].img.toString();
                                final itemName = widget.cateName ==
                                    CategoriesViewAll.foodBeverages
                                    ? foodAndBeverageItemsList[i].name.toString()
                                    : Localizations.localeOf(context).languageCode == 'hi'
                                ...
                                final itemPrice = widget.cateName ==
                                    CategoriesViewAll.foodBeverages
                                    ? foodAndBeverageItemsList[i].productPrice.toString()
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          if (!isActiveButton && itemCounter == 0)
                                            Center(
